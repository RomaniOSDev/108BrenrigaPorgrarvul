...
final class LoadingViewController: UIViewController {
    ...
    private func transitionToContentView() {
        didFinishTransition = true
        // ContentView expects GameProgressStore as an EnvironmentObject.
        // When routing through the loader we must provide it explicitly.
        let content = UIHostingController(rootView: ContentView().environmentObject(GameProgressStore()))
