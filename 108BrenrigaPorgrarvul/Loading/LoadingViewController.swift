...
final class LoadingViewController: UIViewController {
    ...
    private let loadingHosting: UIHostingController<AnyView>

    init(store: GameProgressStore) {
        self.store = store
        self.loadingHosting = UIHostingController(rootView: AnyView(LoadingView()))
    ...
    private func transitionToContentView() {
        didFinishTransition = true
        let content = UIHostingController(rootView: ContentView().environmentObject(store))
